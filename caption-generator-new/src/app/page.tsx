        ...
        <div className="container mx-auto px-4 py-20 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-wrap gap-4 justify-center mb-12">
              <Link
                href="/generate"
                className="px-8 py-3 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-lg font-medium hover:from-emerald-600 hover:to-teal-600 transition-colors flex items-center gap-2"
              >
                <i className="fas fa-magic"></i> Start Creating
              </Link>
              <Link
                href="/pricing"
                className="px-8 py-3 bg-gray-800 rounded-lg font-medium hover:bg-gray-700 transition-colors flex items-center gap-2"
              >
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            <div className="flex items-center gap-3 px-6 py-3 bg-gray-800 rounded-lg text-gray-300 hover:bg-gray-700 transition-colors">
